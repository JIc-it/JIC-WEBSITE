...
const Contact = () => {
    ...
    const Address = [
        { location: 'Kuwait', address: 'Kuwait City, Qibla Block No :15 Street Ali Al Salem Adel Tower Kuwait City, Kuwait', mapUrl: 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13908.188261774689!2d47.9688201!3d29.3689111!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3db2897c05964d6!2sJobin%20International!5e0!3m2!1sen!2sin!4v1651750953563!5m2!1sen!2sin' },
        {
            ...
            mapUrl: 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15742.81005583336!2d76.5398019!3d9.4474639!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x855f586ed262cd0f!2sJIC%20INTERNATIONAL%20HUMAN%20RESOURCES%20PVT%20LTD!5e0!3m2!1sen!2sin!4v1651818856783!5m2!1sen!2sin'
        },

    ]
    const [activeId, setactiveId] = useState(0)
    const [mapUrl, setmapUrl] = useState(Address[0].mapUrl)
                ...
                <div className="col-md-6 col-12">
                    <div className="row px-0 justify-content-center">
                        <div className="col-md-10 col-10">
                            <Map height={'450px'} mapUrl={mapUrl} />
                        </div>
                    </div>
                </div>
                                            ...
                                            <div className="card-header" id="headingOne">
                                                <h5 className="mb-0">
                                                    <div ref={(element) => { ref.current[idx] = element }}>
                                                        <button style={{textTransform:'uppercase'}} onClick={() => setactiveId(idx)} className="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target={`#collapse${item.location}`} aria-expanded="false" aria-controls="collapseOne">
                                                            {item.location}
                                                        </button>
                                                            ...
                                                            <div className="card m-0 card-body">
                                                                ...
                                                                <div>
                                                                    {item.addresses?.map(item => (
                                                                        <div className='mb-3'>
                                                                            <h4 style={{textTransform:'uppercase'}}>{item.location}</h4>
                                                                            <p style={{textTransform:'capitalize'}} >{item.address}</p>
                                                                            <a style={{fontWeight:'400'}} onClick={()=> setmapUrl(item.mapUrl)}>View Map</a>
                                                                        </div>
